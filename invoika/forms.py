...
# Set the Django settings module (Replace 'invoika.settings' with your project settings)
...
LoginForm, SignupForm, ChangePasswordForm, ResetPasswordForm, ResetPasswordKeyForm, SetPasswordForm
)
